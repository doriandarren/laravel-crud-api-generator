...
class GenerateToApiPostman
{
                             ...
                             $relationType, $path): bool
    {
        ...
        $contents .= HelperFiles::formatLineBreakAndTab('"raw": "{{base_url}}' . $tableNameWithGuionPlural . '/list",', null, 1, 7);
        $contents .= HelperFiles::formatLineBreakAndTab('"host": [', null, 1, 7);
        $contents .= HelperFiles::formatLineBreakAndTab('"{{base_url}}' . $tableNameWithGuionPlural . '"', null, 1, 8);
        $contents .= HelperFiles::formatLineBreakAndTab('],', null, 1, 7);
        ...
        $contents .= HelperFiles::formatLineBreakAndTab('},', null, 1, 6);
        $contents .= HelperFiles::formatLineBreakAndTab('"url": {', null, 1, 6);
        $contents .= HelperFiles::formatLineBreakAndTab('"raw": "{{base_url}}' . $tableNameWithGuionPlural . '/list/paginate",', null, 1, 7);
        $contents .= HelperFiles::formatLineBreakAndTab('"host": [', null, 1, 7);
        $contents .= HelperFiles::formatLineBreakAndTab('"{{base_url}}' . $tableNameWithGuionPlural . '"', null, 1, 8);
        $contents .= HelperFiles::formatLineBreakAndTab('],', null, 1, 7);
        $contents .= HelperFiles::formatLineBreakAndTab('"path": [', null, 1, 7);
        ...
        $contents .= HelperFiles::formatLineBreakAndTab('},', null, 1, 6);
        $contents .= HelperFiles::formatLineBreakAndTab('"url": {', null, 1, 6);
        $contents .= HelperFiles::formatLineBreakAndTab('"raw": "{{base_url}}' . $tableNameWithGuionPlural . '/list/paginate?filter=0f609",', null, 1, 7);
        $contents .= HelperFiles::formatLineBreakAndTab('"host": [', null, 1, 7);
        $contents .= HelperFiles::formatLineBreakAndTab('"{{base_url}}' . $tableNameWithGuionPlural . '"', null, 1, 8);
        $contents .= HelperFiles::formatLineBreakAndTab('],', null, 1, 7);
        $contents .= HelperFiles::formatLineBreakAndTab('"path": [', null, 1, 7);
        ...
        $contents .= HelperFiles::formatLineBreakAndTab('},', null, 1, 6);
        $contents .= HelperFiles::formatLineBreakAndTab('"url": {', null, 1, 6);
        $contents .= HelperFiles::formatLineBreakAndTab('"raw": "{{base_url}}' . $tableNameWithGuionPlural . '/show/1",', null, 1, 7);
        $contents .= HelperFiles::formatLineBreakAndTab('"host": [', null, 1, 7);
        $contents .= HelperFiles::formatLineBreakAndTab('"{{base_url}}' . $tableNameWithGuionPlural . '"', null, 1, 8);
        $contents .= HelperFiles::formatLineBreakAndTab('],', null, 1, 7);
        $contents .= HelperFiles::formatLineBreakAndTab('"path": [', null, 1, 7);
        ...
        $contents .= HelperFiles::formatLineBreakAndTab('},', null, 1, 6);
        $contents .= HelperFiles::formatLineBreakAndTab('"url": {', null, 1, 6);
        $contents .= HelperFiles::formatLineBreakAndTab('"raw": "{{base_url}}' . $tableNameWithGuionPlural . '/store",', null, 1, 7);
        $contents .= HelperFiles::formatLineBreakAndTab('"host": [', null, 1, 7);
        $contents .= HelperFiles::formatLineBreakAndTab('"{{base_url}}' . $tableNameWithGuionPlural . '"', null, 1, 8);
        $contents .= HelperFiles::formatLineBreakAndTab('],', null, 1, 7);
        $contents .= HelperFiles::formatLineBreakAndTab('"path": [', null, 1, 7);
